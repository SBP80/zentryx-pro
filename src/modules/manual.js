...
const BASE=[
  ...
  },
  {
    ...
    pasos:[
      ...
      "Dentro de Saneamiento, el botón superior cambia a Resumen cuando hay un bloque o el plano abierto. Al pulsarlo cierra las secciones abiertas y vuelve a la vista compacta sin abandonar Saneamiento ni perder el borrador. Solo cuando ya estás en el resumen principal, Volver sale de Saneamiento hacia la ficha del proyecto.",
