  ...
  modal(`
    ...
    <div class="zx_veh_form">
      ...
      <div class="zx_veh_grid2">
        ...
        <div>
          <label class="zx_veh_label">Seguimiento GPS</label>
          <div class="zx_veh_readonly">${v.seguimiento_gps_habilitado===true || v.seguimiento_gps_habilitado==="true" ? "Activado" : "Desactivado"}</div>
        </div>
      </div>
...
async function guardarVehiculo(id,docActual,nombreDocActual){
  ...
  if(!id) data.seguimiento_gps_habilitado=false;
...
async function abrirFicha(id,tabInicial){
  ...
  auditoriaVehiculo.forEach(function(a){
    ...
    if(accion==="activar_seguimiento_gps" || accion==="desactivar_seguimiento_gps"){
      const activado=accion==="activar_seguimiento_gps";
      movimientos.push({
        fecha:a.fecha,
        titulo:activado?"Seguimiento GPS activado":"Seguimiento GPS desactivado",
...
function instalarCSS(){
  ...
  s.innerHTML=`
    ...
    html[data-zx-theme="dark"] #zx_modal_vehiculo .zx_veh_mov header time{color:#cbd5e1!important}
...
.zx_veh_route_note{display:block;margin-top:12px;line-height:1.35;color:var(--zx-muted);font-weight:700}.zx_veh_route_select{display:block;margin:12px 0}.zx_veh_route_select span{display:block;margin-bottom:6px;color:var(--zx-muted);font-weight:900}.zx_veh_route_select select{width:100%;padding:12px;border:1px solid var(--zx-line);border-radius:14px;background:var(--zx-card);color:var(--zx-text);font-weight:850;font-size:14px;min-width:0}.zx_veh_route_stats>div{background:var(--zx-card);border-color:var(--zx-line)}.zx_veh_route_stats small{color:var(--zx-muted)}@media(max-width:430px){.zx_veh_route_stats{grid-template-columns:1fr 1fr}.zx_veh_route_stats>div:last-child{grid-column:1/-1}.zx_veh_route_stats>div:last-child strong{font-size:13px}.zx_veh_route_select select{font-size:13px}}
...
.zx_grua_actions .disabled{grid-column:1/-1;background:#94a3b8}.zx_grua_actions .blue{background:#2563eb}.zx_grua_actions .purple{background:#7c3aed}.zx_grua_actions .maps{background:#111827}.zx_grua_actions .orange{background:#f97316}.zx_grua_actions .gray{background:#64748b}
    ...
    .zx_inc_detail_head{display:flex;gap:10px;flex-wrap:wrap;margin:8px 0 14px}.zx_inc_status,.zx_inc_severity{background:var(--zx-soft-2);color:var(--zx-text);border:1px solid var(--zx-line);border-radius:999px;padding:7px 11px;font-weight:800;-webkit-text-fill-color:var(--zx-text)}
    ...
    html[data-zx-theme="dark"] #zx_modal_vehiculo .zx_inc_status,html[data-zx-theme="dark"] #zx_modal_vehiculo .zx_inc_severity{background:#202b3d!important;color:#f8fafc!important;border-color:#475569!important;-webkit-text-fill-color:#f8fafc!important}
