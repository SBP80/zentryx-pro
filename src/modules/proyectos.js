// ===============================
// ZENTRYX PRO - PROYECTOS V1088
// V1088 - SANEAMIENTO V7: MOSTRAR SIMULTÁNEAMENTE INCUMPLIMIENTOS Y COMPROBACIONES PENDIENTES DE VENTILACIÓN
...
function metaSaneamientoProyecto(p){
  ...
  return Object.assign({version:6,uso:"privado",tipo_red:"sin_indicar",puntos:[],detalle_red:normalizarDetalleRedSaneamiento(),notas:""},x,{version:Math.max(6,Number(x.version)||1),tipo_red:normalizarTipoRedSaneamiento(x.tipo_red),puntos:normalizarPuntosSaneamientoV2(p,Array.isArray(x.puntos)?x.puntos:[]),detalle_red:normalizarDetalleRedSaneamiento(x.detalle_red)})
}
