...
const NORMATIVA_SANEAMIENTO_ES={ruleset:"ES-CTE-HS5-EVACUACION-AGUAS",verificado_el:"2026-09-10",cte:{nombre:"CTE · DB HS 5 Evacuación de aguas",ref:"HS 5 · tablas 4.1, 4.3 y 4.5 · apartados 3.3.3, 4.1.1 y 4.1.3"}};
...
function normalizarDetalleRedSaneamiento(v={}){
  const x=v&&typeof v==="object"&&!Array.isArray(v)?v:{},vent=x.ventilacion&&typeof x.ventilacion==="object"&&!Array.isArray(x.ventilacion)?x.ventilacion:{};
  ...
  return {longitud_colector_m:numFontOpt(x.longitud_colector_m),pendiente_colector_pct:pendiente,material,
    ...
    ventilacion:{tipo:vt,recorrido:String(vent.recorrido||""),observaciones:String(vent.observaciones||"")}}
}
