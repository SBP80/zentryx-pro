...
// V3069 - CHECKBOX REGCON/DOCUMENTO AISLADOS DE ESTILOS GLOBALES
// ===============================
(function(){
"use strict";

const ZX_VERSION="3067";
...
function abrirModalConvenio(id=""){
  ...
  document.body.insertAdjacentHTML("beforeend",`<div id="zx_modal_convenio" class="zx_modal_fondo"><div class="zx_modal_caja"><div class="zx_modal_top"><h2>${actual.id?"Editar convenio":"Nuevo convenio"}</h2><button id="zx_conv_cerrar">Cerrar</button></div>
    ...
    <div class="zx_conv_checkline"><input id="zx_conv_verificado" type="checkbox" ${actual.verificado?"checked":""}><label for="zx_conv_verificado">He comprobado este convenio en REGCON</label></div>
    ...
    <div class="zx_conv_checkline"><input id="zx_conv_quitar_doc" type="checkbox"><label for="zx_conv_quitar_doc">Quitar el documento actual al guardar</label></div>
...
function instalarCSS(){
  ...
  .zx_modal_caja .zx_conv_checkline{display:grid!important;grid-template-columns:34px minmax(0,1fr)!important;align-items:center!important;column-gap:12px!important;width:100%!important;margin:16px 0 20px!important;padding:0!important;clear:both!important}
  .zx_modal_caja .zx_conv_checkline input[type="checkbox"]{display:block!important;width:32px!important;height:32px!important;min-width:32px!important;max-width:32px!important;min-height:32px!important;max-height:32px!important;margin:0!important;padding:0!important;border:1.5px solid #64748b!important;border-radius:8px!important;box-sizing:border-box!important;-webkit-appearance:checkbox!important;appearance:auto!important;accent-color:#2563eb!important;background:transparent!important;box-shadow:none!important}
  .zx_modal_caja .zx_conv_checkline label{display:block!important;width:auto!important;margin:0!important;padding:0!important;font-size:16px!important;line-height:1.3!important;font-weight:850!important;color:#0f172a!important;white-space:normal!important}
  .zx_modal_caja .zx_conv_checkline + .zx_label{display:block!important;margin-top:4px!important}
