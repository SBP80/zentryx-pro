...
// V3068 - CASILLAS DE CONVENIO CORREGIDAS EN MOVIL
// ===============================
(function(){
"use strict";
...
function abrirModalConvenio(id=""){
  ...
  document.body.insertAdjacentHTML("beforeend",`<div id="zx_modal_convenio" class="zx_modal_fondo"><div class="zx_modal_caja"><div class="zx_modal_top"><h2>${actual.id?"Editar convenio":"Nuevo convenio"}</h2><button id="zx_conv_cerrar">Cerrar</button></div>
    ...
    <label class="zx_check_row"><input id="zx_conv_quitar_doc" type="checkbox"><span>Quitar el documento actual al guardar</span></label>
...
function instalarCSS(){
  ...
  .zx_modal_fondo{position:fixed;inset:0;background:rgba(0,0,0,.55);display:flex;justify-content:center;align-items:center;padding:12px;z-index:9999}.zx_modal_caja{width:100%;max-width:560px;max-height:92vh;overflow-y:auto;background:white;border-radius:20px;padding:18px;box-shadow:0 20px 60px rgba(0,0,0,.35)}.zx_modal_top{display:flex;justify-content:space-between;gap:10px;align-items:center;position:sticky;top:-18px;background:white;padding:15px 0 10px;z-index:2}.zx_modal_top h2{margin:0}.zx_modal_top button{border:0;background:#e2e8f0;border-radius:12px;padding:10px;font-weight:900}.zx_check_row{display:flex;align-items:center;gap:12px;width:100%;margin:10px 0 18px;padding:13px 14px;border:1px solid #dbe3ee;border-radius:14px;background:#f8fafc;box-sizing:border-box;cursor:pointer}.zx_check_row input[type="checkbox"]{appearance:auto;-webkit-appearance:checkbox;flex:0 0 auto;width:24px!important;height:24px!important;min-width:24px!important;min-height:24px!important;margin:0!important;padding:0!important;border-radius:5px}.zx_check_row span{display:block;flex:1;min-width:0;font-size:16px;font-weight:850;line-height:1.3;color:#0f172a}.zx_check_row+.zx_label{display:block;margin-top:4px}.zx_modal_botones{display:grid;grid-template-columns:1fr;gap:8px;margin-top:12px}.zx_modal_botones>button{min-height:46px;border:1px solid #cbd5e1;border-radius:13px;padding:10px 12px;font-weight:900;background:#f8fafc;color:#0f172a}.zx_modal_botones>button:disabled{opacity:.65;background:#f1f5f9;color:#64748b}
